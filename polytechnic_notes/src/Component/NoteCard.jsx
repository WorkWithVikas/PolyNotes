...
const NoteCard = ({ note }) => {
  ...
  return (
    <div 
      ...
      onMouseEnter={() => setIsHimport React, { useState } from "react";
import { Download as DownloadIcon, TagIcon, BookOpen, Calendar, Grid } from "lucide-react";
      ...
      <div className="p-5 space-y-4">
        ...
        <div className="flex flex-wrap gap-2">
          {note.tags?.map((tag, index) => (
            <span key={index} className="bg-blue-50 text-blue-600 px-2 py-1 rounded-full text-xs flex items-center">
        ...
        <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center space-x-2 group">
