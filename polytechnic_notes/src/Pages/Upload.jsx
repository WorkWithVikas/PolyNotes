...
function Upload() {
  ...
  useEffect(() => {
    const fetchLastId = async () => {
      try {
        const response = await databases.listDocuments('67ba052f0033a5682d51', '67ba0564002b5f20147e', { orderDesc: '$id', limit: 1 });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await databases.createDocument('67ba052f0033a5682d51', '67ba0564002b5f20147e', formData.id.toString(), formData);
